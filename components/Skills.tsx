...
const skills = [
  ...
  },
  {
    ...
    mobile: "text-[#ED8B00] [text-shadow:0_0_12px_rgba(237,139,0,0.8)] animate-pulse",
  },
];
      ...
      <div className="rounded-2xl border border-white/10 bg-zinc-900/60 p-6 sm:p-10">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          {skills.map(skill => (
            ...
            >
              <span className={isMobile ? skill.mobile : ""}>
                {skill.name}
              </span>
            </motion.a>
          ))}
